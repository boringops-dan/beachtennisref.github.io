...
(function() {
  ...
  function initCTATracking() {
    document.addEventListener('click', function(e) {
      ...
      if (href.indexOf('app.beachtennisref.app') !== -1) destination_type = 'app';
  ...
  function initOutboundTracking() {
    document.addEventListener('click', function(e) {
      ...
      if (href.indexOf('app.beachtennisref.app') === -1) return;
  ...
  // pointing at app.beachtennisref.app so the app GA4 property can
  // attribute traffic back to the specific marketing page and CTA.

  function initUTMTagging() {
    var links = document.querySelectorAll('a[href*="app.beachtennisref.app"]');
    ...
    links.forEach(function(link) {
      ...
      try {
        ...
        url.searchParams.set('utm_source', 'beachtennisref_site');
